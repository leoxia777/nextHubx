...
export const translationKeys = [
  ...
  'home.page.title',
  'home.components.diagnostics.title',
  'home.components.diagnostics.running',
  'home.components.diagnostics.rerun',
  'home.components.diagnostics.resync',
  'home.components.diagnostics.checks.lanFallback',
  'home.components.diagnostics.checks.ruleProviders',
  'home.components.diagnostics.checks.foreign',
  'home.components.diagnostics.checks.domestic',
  'home.components.diagnostics.checks.ruleSource',
  'home.components.diagnostics.checks.exitIp',
  'home.components.diagnostics.detail.oldConfig',
  'home.components.diagnostics.summary.allGood',
  'home.components.diagnostics.summary.proxyDown',
  'home.components.diagnostics.summary.rulesEmpty',
  'home.components.diagnostics.summary.ruleSourceBlockedOldConfig',
  'home.components.diagnostics.summary.oldConfig',
  'home.components.diagnostics.summary.domesticFail',
  'home.components.diagnostics.summary.exitMismatch',
  'home.components.diagnostics.advice.none',
  'home.components.diagnostics.advice.proxyDown',
  'home.components.diagnostics.advice.resyncOnly',
  'home.components.diagnostics.advice.ruleSourceBlocked',
  'home.components.diagnostics.advice.exitMismatch',
  'home.components.tunHealth.title',
  'home.components.tunHealth.status.running',
  'home.components.tunHealth.status.notReady',
  'home.components.tunHealth.status.leak',
  'home.components.tunHealth.status.off',
  'home.components.tunHealth.desc.running',
  'home.components.tunHealth.desc.notReady',
  'home.components.tunHealth.desc.leak',
  'home.components.tunHealth.desc.off',
  'home.components.tunHealth.action.installService',
  'home.components.tunHealth.action.installing',
  ...
  'layout.components.navigation.tabs.test',
  ...
  'nexthubx.brand',
  'nexthubx.nav.activate',
  'nexthubx.nav.connect',
  'nexthubx.nav.account',
  'nexthubx.activate.title',
  'nexthubx.activate.subtitle',
  'nexthubx.activate.emailLabel',
  'nexthubx.activate.emailPlaceholder',
  'nexthubx.activate.tokenLabel',
  'nexthubx.activate.tokenPlaceholder',
  'nexthubx.activate.resetNotice',
  'nexthubx.activate.resetNoticeWithEmail',
  'nexthubx.activate.submit',
  'nexthubx.activate.submitting',
  'nexthubx.activate.reactivateTitle',
  'nexthubx.activate.verify.verifying',
  'nexthubx.activate.verify.mismatchHint',
  'nexthubx.activate.feedback.success',
  'nexthubx.activate.feedback.empty',
  'nexthubx.activate.feedback.invalid',
  'nexthubx.activate.feedback.networkError',
  'nexthubx.activate.feedback.configError',
  'nexthubx.activate.feedback.unknown',
  'nexthubx.bootstrap.entry',
  'nexthubx.bootstrap.title',
  'nexthubx.bootstrap.hint',
  'nexthubx.bootstrap.codeLabel',
  'nexthubx.bootstrap.codePlaceholder',
  'nexthubx.bootstrap.submit',
  'nexthubx.bootstrap.submitting',
  'nexthubx.bootstrap.feedback.empty',
  'nexthubx.bootstrap.feedback.success',
  'nexthubx.bootstrap.feedback.invalid',
  'nexthubx.bootstrap.feedback.networkError',
  'nexthubx.connect.title',
  'nexthubx.connect.status.connected',
  'nexthubx.connect.status.disconnected',
  'nexthubx.connect.status.connecting',
  'nexthubx.connect.connectButton',
  'nexthubx.connect.disconnectButton',
  'nexthubx.connect.tunMode',
  'nexthubx.connect.systemProxyMode',
  'nexthubx.connect.service.preparingTitle',
  'nexthubx.connect.service.guideTitle',
  'nexthubx.connect.service.guideBody',
  'nexthubx.connect.service.install',
  'nexthubx.connect.service.installing',
  'nexthubx.connect.service.retry',
  'nexthubx.connect.service.skip',
  'nexthubx.connect.service.ready',
  'nexthubx.connect.fallback.title',
  'nexthubx.connect.fallback.body',
  'nexthubx.connect.feedback.connectFailed',
  'nexthubx.connect.feedback.serviceUnavailable',
  'nexthubx.connect.gate.title',
  'nexthubx.connect.gate.body',
  'nexthubx.connect.gate.install',
  'nexthubx.connect.gate.installing',
  'nexthubx.connect.gate.retry',
  'nexthubx.connect.gate.failed',
  'nexthubx.connect.gate.supportTitle',
  'nexthubx.connect.gate.supportBody',
  'nexthubx.connect.gate.retryAnyway',
  'nexthubx.account.title',
  'nexthubx.account.email',
  'nexthubx.account.password',
  'nexthubx.account.copy',
  'nexthubx.account.copied',
  'nexthubx.account.showPassword',
  'nexthubx.account.hidePassword',
  'nexthubx.account.empty',
  'nexthubx.account.reactivate',
  'nexthubx.account.usage.title',
  'nexthubx.account.usage.body',
  'nexthubx.account.bind.pendingTitle',
  'nexthubx.account.bind.pendingBody',
  'nexthubx.account.bind.invitedTitle',
  'nexthubx.account.bind.invitedBody',
  'nexthubx.account.bind.confirmButton',
  'nexthubx.account.bind.confirming',
  'nexthubx.account.bind.confirmOk',
  ...
  'nexthubx.account.bind.creatorBody',
  'nexthubx.account.bind.creatorConfirm',
  'nexthubx.account.bind.creatorBoundLabel',
  ...
  'nexthubx.account.totp.title',
  'nexthubx.account.totp.hint',
  'nexthubx.sync.configUpdated',
  'nexthubx.sync.revokedNotice',
  'nexthubx.sync.failed',
  'nexthubx.exitGuard.title',
  'nexthubx.exitGuard.body',
  'nexthubx.exitGuard.notifyTitle',
  'nexthubx.exitGuard.notifyBody',
  'nexthubx.clashVergeConflict.title',
  'nexthubx.clashVergeConflict.runningBody',
  'nexthubx.clashVergeConflict.appearedBody',
  'nexthubx.clashVergeConflict.steps',
  'nexthubx.clashVergeConflict.blockingActivate',
  'nexthubx.clashVergeConflict.forceStopHint',
  'nexthubx.clashVergeConflict.forceStop',
  'nexthubx.clashVergeConflict.forceStopping',
  'nexthubx.clashVergeConflict.forceStopOk',
  'nexthubx.clashVergeConflict.forceStopCancelled',
  'nexthubx.clashVergeConflict.forceStopStillRunning',
  'nexthubx.clashVergeConflict.forceStopFailed',
  'nexthubx.clashVergeConflict.recheck',
  'nexthubx.clashVergeConflict.confirm',
  ...
  'settings.sections.system.tooltips.locked',
  ...
  'settings.sections.system.fields.unifiedDelay',
  'settings.sections.system.fields.allowLan',
